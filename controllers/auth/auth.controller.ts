...
import { forgotPassword, googleSignIn, login, register, resetPassword, verifyAccount } from "../../services/auth.service";
...
export const googleSignInController = expressAsyncHandler(async (req: Request<{}, {}, { accessToken: string }>, res) => {
  await googleSignIn(req.body.accessToken);
